...
public class Chessboard {
	...
	private int AILastX = -1, AILastY = -1;//电脑最后下的位置
	/**
	 * 初始化棋盘
	 * 
	 * @return void
	...
	public int getAILastX() {
		return AILastX;
	}

	public void setAILastX(int aILastX) {
		AILastX = aILastX;
	}

	public int getAILastY() {
		return AILastY;
	}

	public void setAILastY(int aILastY) {
		AILastY = aILastY;
	}
